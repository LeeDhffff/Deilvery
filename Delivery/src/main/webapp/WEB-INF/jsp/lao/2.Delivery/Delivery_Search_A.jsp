            ...
            <div class="historyBody">
                <div class="tableWrap">
                    <table id="Delivery_History_Table">
                        <thead>
                            <tr>
                                <th>ຊື່ຜູ້ຮັບເຄື່ອງ</th>
                                <th>ຄ່າຂົນ(ໂດຍປະມານ)</th>
                                <th>물품내역</th>
                            </tr>
                        </thead>
                        <tbody>
...
<!--                             회원님의 운송장번호는 2024010845 입니다.<br> -->
        ...
        <div class="inputsection">
                <div class="inputWrap">
	        	<h3 class="inputName"><a href="#">ເລືອກສະຖານທີ່ຮັບເຄື່ອງ</a></h3>
	        ...
	        <button class="savebutton">ບັນທຶກ
	        </button>
                            ...
                            <table id="Delivery_Table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ປິດຮັບເຄື່ອງ</th>
                                        <th>ຊື່ຜູ້ຮັບເຄື່ອງ</th>
                                        <th>ເຄື່ອງເຂົ້າສາງ</th>
                                        <th>ຄ່າຂົນ(ໂດຍປະມານ)</th>
<!--                                         <th>배송현황</th> -->
                                        <th>ກວດລາຍລະອຽດເຄື່ອງ</th>
                                    </tr>
                                </thead>
                                <tbody>
									<tr class="tron">
...
<!-- 									<td class="currentClickOne" style="cursor:pointer;">한국물류창고 (클릭)</td> -->
                        ...
                        <div class="currentWrap one">
                            <h3 class="conMainTitle">
                                <a href="#">ສະຖານະການ ການຂົນສົ່ງ<span class="out_txt">${Dlist.OUT_TXT}</span></a>
<!--                                 <button class="qr">배송정보</button> -->
                            ...
                            <div class="currentCon">
                                <div class="current one on">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ສາງເຄື່ອງຢູ່ເກົາຫຼີ</a></h5>
                                ...
                                <div class="current two">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ສາຍເຮືອອິນຊອນ</a></h5>
                                    <h5 class="currentDay"><a href="#"></a></h5>
                                    <h5 class="currentMessage"><a href="#"></a></h5>
                                </div>
                                <div class="current three">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ກຳລັງຈັດສົ່ງ</a></h5>
                                    <h5 class="currentDay"><a href="#"></a></h5>
                                    <h5 class="currentMessage"><a href="#"></a></h5>
                                </div>
                                <div class="current four">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ສາຍເຮຶອໄທ</a></h5>
                                    <h5 class="currentDay"><a href="#"></a></h5>
                                    <h5 class="currentMessage"><a href="#"></a></h5>
                                </div>
                                <div class="current five">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ສາງເຄື່ອງຢູ່ລາວ</a></h5>
                                    <h5 class="currentDay"><a href="#"></a></h5>
                                    <h5 class="currentMessage"><a href="#"></a></h5>
                                </div>
                                <div class="current six">
                                    ...
                                    <h5 class="currentTitle"><a href="#">ເລີ່ມກະຈາຍເຄື່ອງ</a></h5>
                                    <h5 class="currentDay"><a href="#"></a></h5>
                                    <h5 class="currentMessage"><a href="#"></a></h5>
                                </div>
                            </div>
